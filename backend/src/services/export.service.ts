...
export class ExportService {
   ...
   */
  static async exportJSON(userId: string) {
    const [user, metrics, usageRecords, focusSessions, routines, achievements, automations] =
      await Promise.all([
   ...
   */
  static async exportHTMLDigest(userId: string): Promise<string> {

...
import { calculateAttentionScore, calculateScrollCost, formatMinutes, } from '../utils/durationParser.js';
export class AnalyticsService {
    /**
     * Recalculates DailyMetric for a user and date based on all confirmed UsageRecords
     */
    static async recalculateDailyMetric(userId, date) {
     ...
     */
    static async getDailyOverview(userId, requestedDate) {
        ...
        return {
            ...
            metrics: {
                ...
                shortForm: {
                    ...
                    percentageOfScreenTime: currentScreenTime > 0 ? Math.round((currentShorts / currentScreenTime) * 100) : 0,
                },
                focusTime: {
     ...
     */
    static async getTrends(userId, days = 7) {
